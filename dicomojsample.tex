...
また，比較対象として prototype 正則化なしの基本統合モデル（AFAD Hybrid）も示す．
...
\begin{table}[htb]
  ...
  \begin{tabular}{lp{1.9cm}p{1.2cm}p{1.4cm}}
    ...
    \textbf{AFAD+Proto}   & \textbf{全端末（10台）} & \textbf{あり} & \textbf{82.93} \\
    \bottomrule
  \end{tabular}
\end{table}

AFAD+Proto はサーバ精度 82.93\% を達成し，
ViT 端末を含む全 10 台という困難な条件下でありながら，
CNN 端末 6 台のみを対象とした HeteroFL（82.20\%）を上回った．
